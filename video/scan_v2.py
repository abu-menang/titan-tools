...
from common.shared.loader import load_media_types, load_task_config, load_yaml_resource
...
def vid_mkv_scan(
    ...
    _write("ext_sub_non_hevc_mkv", [mkv_ext_issues_non_hevc], TRACK_COLUMNS)
    ...
    try:
        ...
        try:
            ...
            totals_html = (
                ...
                f"Non-HEVC rows: <strong>{len(mkv_non_hevc_rows) + len(non_mkv_non_hevc_rows)}</strong> &nbsp; "
