...
from common.base.ops import run_command, move_to_trash, move_file
from common.shared.report import write_csv, timestamped_filename, summarize_counts
...
def vid_non_hevc():
    ...
    if args.csv_report:
        write_csv(results, timestamped_filename("non_hevc"), dry_run=args.dry_run)
...
if __name__ == "__main__":
    # Example: python -m video.non_hevc --root ./videos --dry-run
    vid_non_hevc()
